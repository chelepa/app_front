...
export const PermissionCreate = () => {
  ...
  return (
    <Container customClass="" msg={msg} type={messageType} showLoading={false}>
      <PanelBobyView title="Modulo de Cadastro" redirect="/permission" handleOnChangeDelete={""} handleOnChangeUpdateOrCreate={handleOncreate} saveOrDelete={false} enableSave={false}>
